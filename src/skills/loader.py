"""
SkillLoader - Loads and manages skills from SKILL.md files.
...
class SkillLoader:
    ...
    - Layer 1: Metadata (name, description) - always loaded (~100 tokens/skill)
    - Layer 2: SKILL.md body - loaded on trigger (~2000 tokens)
    - Layer 3: Resources (scripts/, references/, assets/) - hints provided
    """
    ...
    def load_skills(self):
        ...
        This keeps the initial context lean (Layer 1 only).
        """
